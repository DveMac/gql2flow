...
${exportOrDeclare} type GraphQLResponseErrorLocation = {
  ...
  column: number;
    ...
    const generateInterfaceDeclaration = (description, declaration, fields, additionalInfo) =>
...
${fields}
    ...
    const fieldToDefinition = field => {
        ...
        const nullKeyCharacter = options.nullKeys || !isNotNull || (options.nullKeysFromValues && !isNotNull) ? '?' : ''
